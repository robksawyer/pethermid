      ...
      <div className={s.root}>
        <div className={s.container}>
          <div className={s.details}>
            <h4 className="lh-title f4 sans-serif green">
          ...
          <div className={s.how}>
            <h3>How does the coin pyramid work?</h3>
            <ol>
              <li>
                Send your desired amount of Ethereum coins via QR code or link.
              </li>
              <li>We process five new tranactions randomly.</li>
              <li>
                Add the total Ethereum collected from the random transactions.
                Math!
              </li>
              <li>
                Remove the 2% transaction fee.&nbsp;Why? For coin distribution
                and running service.
              </li>
              <li>Divide the rest of the Ethereum coins.</li>
              <li>
                Distribute coins to the users who were participants in the
                transaction group.
              </li>
              <li>
                You potentially get more Ethereum than you originally invested.
              </li>
              <li>
                No refunds. Play at your own risk.&nbsp;
                <span className={s.warning}>No guarantees of any kind.</span>
              </li>
            </ol>
          </div>
